...
<form>
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $this->tag->textField(["nom", "size" => 30, "class" => "form-control", "id" => "fieldNom", "value" => $profile->nom]) ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $this->tag->textField(["prenom", "size" => 30, "class" => "form-control", "id" => "fieldPrenom", "value" => $profile->prenom]) ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $this->tag->textField(["adress", "size" => 30, "class" => "form-control", "id" => "fieldAdress", "value" => $profile->adress]) ?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $this->tag->textArea(["description", "cols" => 30, "rows" => 4, "class" => "form-control", "id" => "fieldDescription", "value" => $profile->description]) ?>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
            <?php echo $this->tag->submitButton(["Update Profile", "class" => "btn btn-default"]) ?>
        </div>
    </div>
